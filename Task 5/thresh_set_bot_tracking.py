...
counter = 20 # 20th frame is used to get threshold value 
while counter>0:
	_,image = cap.read()
	counter-=1 
cap.release()
def main():
	...
	while True:	
		...
		#cv2.arrowedLine(frame, (cX,cY),(cX2,cY2), (0,0,255), 2)
		theta = math.atan2((cY2-cY),(cX2-cX))*(180/3.1414)
		if theta<0:
			theta+=360
		cv2.putText(frame, str(theta),center, cv2.FONT_ITALIC,0.5, (0,0,255), 2)
		cv2.imshow('hope',frame)
		q=cv2.waitKey(40) & 0xff	
		if q == 27:
			break			
